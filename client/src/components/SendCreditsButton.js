...
exports.SendCreditsButton = void 0;
...
const SendCreditsButton = (props) => {
    const handleSendCredits = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, jsx_runtime_1.jsx)("button", { onClick: handleSendCredits, children: "Send Credits" });
};
exports.SendCreditsButton = SendCreditsButton;
